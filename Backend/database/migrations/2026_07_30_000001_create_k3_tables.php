...
return new class extends Migration
{
    ...
    {
        // ── 1. k3_categories ────────────────────────────────────────────────
        if (!Schema::hasTable('k3_categories')) {
        ...
        // ── 2. k3_criteria ──────────────────────────────────────────────────
        if (!Schema::hasTable('k3_criteria')) {
        ...
        if (!Schema::hasTable('k3_criteria_levels')) {
        ...
        if (!Schema::hasTable('k3_assessments')) {
