  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:24 }} className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
        <KpiCard title="Realisasi kWh YTD" value={hasData?formatNumber(ytdReal):'—'} unit="kWh" icon={BarChart2} color="green" achievement={hasData ? achKPI : undefined} loading={loading} />
