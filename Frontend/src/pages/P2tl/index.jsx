...
import { Activity, AlertCircle, Target, Plus, Zap, TrendingUp, FileSpreadsheet } from 'lucide-react';
...
export default function P2tlPage() {
  ...
  const handleExportExcel = async () => {
    ...
    await exportWithChart({
      data: exportData,
      filename: `P2TL_${filters.year || new Date().getFullYear()}`,
      columns: [
        { header: 'Bulan', key: 'Bulan' },
        { header: 'Target Bulanan (kWh)', key: 'Target Bulanan' },
        { header: 'Realisasi Bulanan (kWh)', key: 'Realisasi Bulanan' },
        { header: 'Target Kumulatif (kWh)', key: 'Target Kumulatif' },
        { header: 'Realisasi Kumulatif (kWh)', key: 'Realisasi Kumulatif' },
      ],
      sheetName: 'P2TL',
      chartRef,
      title: `Data P2TL Tahun ${filters.year || new Date().getFullYear()}`,
    })
  }
