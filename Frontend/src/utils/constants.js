    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'k3-assessment-aai', label: 'AAI', path: '/k3/assessment/aai', icon: 'FileText' },
          { key: 'k3-assessment-ibp', label: 'IBP', path: '/k3/assessment/ibp', icon: 'FileText' },
          { key: 'k3-assessment-ste', label: 'STE', path: '/k3/assessment/ste', icon: 'FileText' },
          { key: 'k3-assessment-scc', label: 'SCC', path: '/k3/assessment/scc', icon: 'FileText' },
          { key: 'k3-assessment-rep', label: 'REP', path: '/k3/assessment/rep', icon: 'FileText' },
        ],
      },
    ],
  },
