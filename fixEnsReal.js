...
const markerText = 'placeholder="-" \n                 />\n               </div>\n            </div>';
const markerIndex = kinerjaContent.indexOf(markerText, kinerjaStart);
const kinerjaEnd = markerIndex + markerText.length;
...
console.log('Fixed InputEns/index.jsx perfectly!');
